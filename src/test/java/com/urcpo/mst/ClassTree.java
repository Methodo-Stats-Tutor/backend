...
public class ClassTree {
    ...
    public void PelletClassTree( String ontology ) throws Exception {
        // create a reasoner
    ...
    public  void Test() throws Exception {
        ...
        PelletClassTree( "/home/nps/Projets/stat-tutor/STATO/product.owl" );

        JFrame frame = new JFrame( "Ontology Hierarchy" );
        frame.getContentPane().add( new JScrollPane( getJTree() ) );
