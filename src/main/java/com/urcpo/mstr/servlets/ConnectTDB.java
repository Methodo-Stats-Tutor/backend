...
import com.urcpo.mstr.reasoner.ReasonerStudentClassificationService;
...
public class ConnectTDB extends HttpServlet {
    ...
    public static String getSparqlResultAsJsonFromReasoner(String sparqlQuery, OntModel om) {
        ...
        QueryExecution qexec = null;
        dataset.begin(ReadWrite.READ);
        OntModel ontModel = ModelFactory.createOntologyModel(PelletReasonerFactory.THE_SPEC,ModelFactory.createUnion(ModelFactory.createDefaultModel().read( "/app/mstr/ontologies/int/mst.owl" ), dataset.getDefaultModel()));
 OutputStream outputStream;
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        dataset = DatasetFactory.assemble("/app/mstr/config/text-config.ttl", "http://localhost/jena_example/#text_dataset");
        ...
        //  Directory dir =  null;
//        try {
//            dir = FSDirectory.open(new File("/app/mstr/lucene"));
