...
@Subject( namespace = "http://methodo-stat-tutor.com#", types = { "http://methodo-stat-tutor.com#Picture","http://methodo-stat-tutor.com#CourseMaterial" } )
public class Picture extends CourseMaterial implements JsonBeans {
    ...
    public String toJson() {
        ...
        m.put("description", MstrUtils.quote( getDescription() ) );
